...
public class OthelloControllerRandomVSRandom {
	...
	private final PlayerRandom player1, player2;
	...
	/**
	 * Begin a game of Othello between 2 computers that picks its move randomly.
	 * This function calls the getMove() function which is taken from the various
	 * player classes which have different implementations of getMove().
	 *
